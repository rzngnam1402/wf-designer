    ...
    return (
        <div className='toolBox_container'>
            ...
            <ul className="toolBox_list_option">
                <li className="toolBox_title" key={ListContainers.title.id} onClick={() => setShowContainers(!showContainers)}>{ListContainers.title.content}
                    {showContainers ? <i className="fa-solid fa-angle-down"></i> : <i className="fa-solid fa-angle-right"></i>}
                </li>
                {showContainers && <ToolBoxItem listItem={ListContainers.item} />}

                <li className="toolBox_title" key={ListCollections.title.id} onClick={() => setShowCollections(!showCollections)}>{ListCollections.title.content}
                    {showCollections ? <i className="fa-solid fa-angle-down"></i> : <i className="fa-solid fa-angle-right"></i>}
                </li>
                {showCollections && <ToolBoxItem listItem={ListCollections.item} />}

                <li className="toolBox_title" key={ListControls.title.id} onClick={() => setShowControls(!showControls)}>{ListControls.title.content}
                    {showControls ? <i className="fa-solid fa-angle-down"></i> : <i className="fa-solid fa-angle-right"></i>}
                </li>
                {showControls && <ToolBoxItem listItem={ListControls.item} />}

                <li className="toolBox_title" key={ListCharts.title.id} onClick={() => setShowCharts(!showCharts)}>{ListCharts.title.content}
                    {showCharts ? <i className="fa-solid fa-angle-down"></i> : <i className="fa-solid fa-angle-right"></i>}
                </li>
                {showCharts && <ToolBoxItem listItem={ListCharts.item} />}

                <li className="toolBox_title" key={ListTemplates.title.id} onClick={() => setShowTemplates(!showTemplates)}>{ListTemplates.title.content}
                    {showTemplates ? <i className="fa-solid fa-angle-down"></i> : <i className="fa-solid fa-angle-right"></i>}
                </li>
